...
export function AIChat() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] bg-white rounded-lg shadow flex flex-col">
      {/* Header */}
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">AI Marine Assistant</h2>
            <p className="text-sm text-gray-600">Powered by advanced ocean data analytics</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {suggestedQuestions.map((question, index) => (
              <button
                ...
                className="text-left text-sm bg-white border border-gray-200 rounded-lg p-3 hover:border-blue-300 hover:bg-blue-50 transition-colors"
              >
                {question}
              </button>
            ))}
