                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div className="space-y-3">
                      <button className="w-full text-left px-4 py-3 bg-gray-50 rounded-lg hover:bg-gray-100">
                        ...
                        <div className="text-sm text-gray-600">Download your research data and settings</div>
                      </button>
                      <button className="w-full text-left px-4 py-3 bg-red-50 rounded-lg hover:bg-red-100">
